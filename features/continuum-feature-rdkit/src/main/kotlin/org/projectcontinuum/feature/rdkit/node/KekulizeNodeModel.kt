 ...
 * Kekulize Node Model
 *
 * Converts aromatic SMILES strings to their Kekule (explicit double-bond) form using RDKit.
 * For each row in the input table, the node reads a SMILES string from the configured column,
 * parses it into an RDKit molecule object, creates a writable RWMol copy, applies Kekulize(),
 ...
 *
 * **Output Ports:**
 * - `output`: Table with all original columns plus a new column containing Kekule SMILES
 *
 * **Configuration Properties:**
 * - `smilesColumn` (required): Name of the column containing SMILES strings
 * - `newColumnName` (optional, default "kekule_smiles"): Name for the new output column
 ...
 */
@ContinuumNode
class KekulizeNodeModel : ProcessNodeModel() {
    companion object {
        private val LOGGER = LoggerFactory.getLogger(KekulizeNodeModel::class.java)
        ...
        """
        {
          ...
          "properties": {
            ...
            "newColumnName": {
              ...
              "description": "Name for the new column containing Kekule SMILES",
              "default": "kekule_smiles"
            },
            "removeSourceColumn": {
              "type": "boolean",
    ...
    override val metadata = ContinuumWorkflowModel.NodeData(
        ...
        description = "Converts aromatic SMILES to Kekule form using RDKit",
        title = "Kekulize",
        subTitle = "Convert aromatic SMILES to Kekule form via RDKit",
        ...
        properties = mapOf(
            ...
            "newColumnName" to "kekule_smiles",
    ...
    override fun execute(
        ...
        val newColumnName = properties["newColumnName"]?.toString() ?: "kekule_smiles"
        val removeSourceColumn = properties["removeSourceColumn"] as? Boolean ?: false

        LOGGER.info("Kekulizing SMILES from column '$smilesColumn' into '$newColumnName' (removeSource=$removeSourceColumn)")
        ...
        LOGGER.info("Kekulize conversion completed: processed rows")
    }
}
